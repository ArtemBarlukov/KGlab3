...
float frameWidth = 1.0f / 10.0f;  // Ширина одного кадра в текстурных координатах
...
void Init()
{
    Menu_AddButton("JUMP",20,20,200,60,4);
    Menu_AddButton("RUN",20,100,200,60,4);
    Menu_AddButton("IDLE",20,180,200,60,4);
    Menu_AddButton("QUIT",20,260,200,60,4);
